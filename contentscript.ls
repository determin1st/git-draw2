...
do !->
	...
	legend.state = 1
	legend[legend.state].classList.add 'active'
	rect.state = 0
	btns.state = false
	# }}}
	legendSelect = (e) !-> # {{{
		...
		legend[legend.state].classList.remove 'active'
